...
def CreateMenuBar(master, mb_row, mb_column, pad_x, pad_y):
    ...
    menu_frame.columnconfigure((0,1,2,3), weight=1)
    menu_frame.grid_propagate(False)

    card_menu = ctk.CTkButton(master=menu_frame, text='Cards', fg_color=menubar_innercolor)
    card_menu.grid(row=0, column=0, padx=menubar_inner_pad, pady=menubar_inner_pad, sticky='ew')
    team_menu = ctk.CTkButton(master=menu_frame, text='Teams', fg_color=menubar_innercolor)
    team_menu.grid(row=0, column=1, padx=menubar_inner_pad, pady=menubar_inner_pad, sticky='ew')
    cat_menu = ctk.CTkButton(master=menu_frame, text='Categories', fg_color=menubar_innercolor)
    cat_menu.grid(row=0, column=2, padx=menubar_inner_pad, pady=menubar_inner_pad, sticky='ew')
    links_menu = ctk.CTkButton(master=menu_frame, text='Links', fg_color=menubar_innercolor)
    links_menu.grid(row=0, column=3, padx=menubar_inner_pad, pady=menubar_inner_pad, sticky='ew')